...
const HowItWorks = () => {
  return (
    <div className='container mx-auto font-krub pb-40 overflow-hidden relative'>
      ...
      <div className='max-md:hidden relative float-right font-bold tracking-widest before:content-[""] before:top-4 before:-left-24 before:absolute before:border-solid before:border-[3px] before:w-[66px]'>
